...
//! before shipping. (Field order was cross-checked against the
//! `statvfs(3)` man page during this session -- see
//! docs/compatibility.md's "FFI verification" note.)
...
pub const USAGE: &str = "df [PATH...] -- report filesystem space usage (Linux)";
